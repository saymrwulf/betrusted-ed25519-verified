/- ──────────────────────────────────────────────────────────────────────────────
   ...
   RUST ANALOG (curve25519-dalek v4.1.2 (betrusted fork): TWO loops — loop0 = borrow chain; loop1 adds
   L &&& underflow_mask (pure arithmetic-mask constant-time conditional))
